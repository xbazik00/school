...
protected:
   ...
   /**
    * @brief head
    * Ukazatel na koniec fronty.
    */
	Element_t *head;

   /**
    * @brief FindInsert
    * Vracia ukazatel na prvok, pred ktory moze metoda "Insert" vlozit novy prvok na
    * zaklade hodnoty "value".
    * @param "value" hondota vkladaneho prvku
    * @return Ukazatel, pred ktory je mozne vkladat, ak ho nenajde, tak NULL
    */
	Element_t *FindInsert(int value);
